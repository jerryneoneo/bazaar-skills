...
union of your seller and buyer markets), finds threads you started **outside** Bazaar, and offers to
...
- You rarely need to run it by hand: `/bazaar-run` (§2b) auto-sweeps each enabled inbox on a cadence
